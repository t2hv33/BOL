...
function OnLoad()
	...
	Menu:addSubMenu("Combo", "Combo")
		Menu.Combo:addParam("UseQ", "Dùng Q", SCRIPT_PARAM_ONOFF, true)
		Menu.Combo:addParam("UseW", "Dùng W", SCRIPT_PARAM_ONOFF, true)
		Menu.Combo:addParam("UseE", "Dùng E", SCRIPT_PARAM_ONOFF, true)
		Menu.Combo:addParam("UseR", "Dùng R", SCRIPT_PARAM_ONOFF, true)
		Menu.Combo:addParam("Enabled", "Dùng Combo!", SCRIPT_PARAM_ONKEYDOWN, false, 32)

	Menu:addSubMenu("Harass", "Harass")
		Menu.Harass:addParam("UseQ", "Dùng Q", SCRIPT_PARAM_ONOFF, true)
		Menu.Harass:addParam("UseW", "Dùng W", SCRIPT_PARAM_ONOFF, true)
		Menu.Harass:addParam("ManaCheck", "Không quây'rôi'khi mana < %", SCRIPT_PARAM_SLICE, 0, 0, 100)
		Menu.Harass:addParam("Enabled", "Quây'Rôi'!", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("C"))

	Menu:addSubMenu("Farm", "Farm")
		Menu.Farm:addParam("UseQ",  "Dùng Q", SCRIPT_PARAM_LIST, 1, { "No", "Freeze", "LaneClear", "Both" })	
		Menu.Farm:addParam("UseW",  "Dùng W", SCRIPT_PARAM_LIST, 3, { "No", "Freeze", "LaneClear", "Both" })
		Menu.Farm:addParam("UseE",  "Dùng E", SCRIPT_PARAM_LIST, 4, { "No", "Freeze", "LaneClear", "Both" })
		Menu.Farm:addParam("ManaCheck", "Không farm khi mana < %", SCRIPT_PARAM_SLICE, 0, 0, 100)
		Menu.Farm:addParam("Freeze", "Ðong'Ba*ng creep", SCRIPT_PARAM_ONKEYDOWN, false,   string.byte("C"))
		Menu.Farm:addParam("LaneClear", "Ðây?Ðuong`", SCRIPT_PARAM_ONKEYDOWN, false,   string.byte("V"))

	Menu:addSubMenu("JungleFarm", "JungleFarm")
		Menu.JungleFarm:addParam("UseQ",  "Dùng Q", SCRIPT_PARAM_ONOFF, false)
		Menu.JungleFarm:addParam("UseW",  "Dùng W", SCRIPT_PARAM_ONOFF, true)
		Menu.JungleFarm:addParam("UseE",  "Dùng E", SCRIPT_PARAM_ONOFF, true)
		Menu.JungleFarm:addParam("Enabled", "Farm!", SCRIPT_PARAM_ONKEYDOWN, false,   string.byte("V"))

	Menu:addSubMenu("Ultimate", "R")
		Menu.R:addSubMenu("Không dùng R trên", "Targets")
		...
		Menu.R:addParam("AutoR", "Auto R khi trúng: ", SCRIPT_PARAM_LIST, 1, { "No", ">0 targets", ">1 targets", ">2 targets", ">3 targets", ">4 targets" })
		Menu.R:addParam("CastR", "Cast R ngay lâp.tuc'", SCRIPT_PARAM_ONKEYDOWN, false, string.byte("J"))

	Menu:addSubMenu("Misc", "Misc")
		Menu.Misc:addParam("AutoQ", "Auto Q khi nó nhào Ðên'", SCRIPT_PARAM_ONOFF, true)
		Menu.Misc:addParam("AutoQ2", "Auto Q vào Ðich.Ða~stun", SCRIPT_PARAM_ONOFF, true)
		Menu.Misc:addParam("AutoW", "Auto W vào Ðich.Ða~stun", SCRIPT_PARAM_ONOFF, true)
