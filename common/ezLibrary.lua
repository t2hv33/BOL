...
return {
	...
	["Ahri"] = {charName = "Ahri", skillshots = {
        ...
        ["Charm"] = {spellKey = _E, isCollision = true, name = "Charm", spellName = "AhriSeduce", spellDelay = 250, projectileName = "Ahri_Charm_mis.troy", projectileSpeed = 1600, range = 975, radius = 60, type = "LINE"},
	...
	--unfinished
		...
		["Pulverize"] = {spellKey = _Q, isSelfCast = true, name = "Pulverize", spellName = "Pulverize", spellDelay = 250, projectileName = "swain_shadowGrasp_transform.troy", range = 180, type = "CIRCULAR"},
	}},
	...
	--unfinished
		...
		["Nether Blade"] = {spellKey = _W, isSelfCast = true, isAutoBuff = true, noAnimation = true, name = "Nether Blade", spellName = "NetherBlade", spellDelay = 250, range = 250, type = "CIRCULAR"},
		["Force Pulse"] = {spellKey = _E, name = "Force Pulse", spellName = "ForcePulse", spellDelay = 250, range = 700, radius = 200, type = "LINE"},
	}},
	...
	["Khazix"] = {charName = "Khazix", skillshots = {
        ["KhazixQ"] = {s = _Q, isTargeted = true, name = "KhazixQ", spellName = "KhazixQ", spellDelay = 250, projectileName = "swain_shadowGrasp_transform.troy", range = 375, type = "LINE"},
    ...
    ["Nami"] = {charName = "Nami", skillshots = {
		...
		["Ebb and Flow"] = {spellKey = _W, isTargeted = true, name = "Ebb and Flow", spellName = "EbbAndFlow", spellDelay = 250, range = 725, projectileName = "swain_shadowGrasp_transform.troy", type = "LINE"},
	...
	["Nidalee"] = {charName = "Nidalee", skillshots = {
        ["NidaleeTakedownAttack"] = {spellKey = _Q, isSelfCast = true, isExecute = true, isAutoReset = true, checkName = true, name = "NidaleeTakedownAttack", spellName = "NidaleeTakedownAttack", spellDelay = 250, range = 125, type = "CIRCULAR"},
		["Javelin Toss"] = {spellKey = _Q, isCollision = true, name = "Javelin Toss", spellName = "JavelinToss", spellDelay = 125, projectileName = "nidalee_javelinToss_mis.troy", projectileSpeed = 1300, range = 1500, radius = 60, type = "LINE"}
    }},
	...
	["Shyvana"] = {charName = "Shyvana", skillshots = {	
		["ShyvanaDoubleAttack"] = { spellKey = _Q, isAutoReset = true, spellName = "ShyvanaDoubleAttack", name = "ShyvanaDoubleAttack", range = 125, },
	...
	["Trundle"] = {charName = "Trundle", skillshots = {
		...
		["TrundleTrollSmash"] = { spellKey = _Q, isAutoReset = true, spellName = "TrundleTrollSmash", name = "TrundleTrollSmash", range = 125,},
	...
	["Zyra"] = {charName = "Zyra", skillshots = {
        ...
        ["ZyraBrambleZone"] = { spellKey = _R, spellName = "ZyraBrambleZone", name = "ZyraBrambleZone", range = 700, spellDelay = 250},
