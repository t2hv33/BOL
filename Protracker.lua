...
function OnLoad()
	Menu = scriptConfig("ProTrackerv1", "ProTrackerv1")
	...
	PrintChat("<font color=\"#81BEF7\">ProTracker ("..version..") loaded successfully</font>")
end
...
function OnDraw()
	if (Menu.Enabled or Menu.Enabled2) and FirstTick and (Menu.Drawing.Always or Menu.Drawing.DrawKey) then
		for i=1, heroManager.iCount, 1 do
			local hero = heroManager:getHero(i)
			if ((ValidTarget(hero, math.huge,false)  and Menu.Enabled2) or (ValidTarget(hero) and Menu.Enabled)) and not hero.isMe then
